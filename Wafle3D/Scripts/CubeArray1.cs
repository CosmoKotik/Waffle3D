...
public class CubeArray1 : WafleBehaviour
{
    ...
    public override void OnUpdate()
    {
        ...
        gameEngine.SetPosition(new OpenTK.Vector3(0, 0, xx), IDOffset);
        ...
        //gameEngine.SetRotation(new OpenTK.Vector3(y, y, y), gameEngine.TotalObjectCount - 1);
        //gameEngine.SetPosition(-new OpenTK.Vector3(asd, 0, 0), 0);
